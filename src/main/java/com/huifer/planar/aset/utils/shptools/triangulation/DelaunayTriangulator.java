...
//
//        Vector2D vector2D1 = new Vector2D(106.544677734375, 34.27349853515625);
//        Vector2D vector2D2 = new Vector2D(108.944091796875, 23.2711181640625);
//        Vector2D vector2D3 = new Vector2D(92.7332763671875, 21.86669921875);
//        Vector2D vector2D4 = new Vector2D(91.094482421875 ,31.757080078125);
//
//        Vector2D vector2D5 = new Vector2D(104.3792724609375 ,29.88427734375);
//        Vector2D vector2D6 = new Vector2D(98.85369873046875 ,29.36212158203125);
//        Vector2D vector2D7 = new Vector2D(98.00030517578125, 25.4365234375);
//        Vector2D vector2D8 = new Vector2D(105.198486328125 ,25.0853271484375);
//
//        pointSet.add(vector2D1);
//        pointSet.add(vector2D2);
//        pointSet.add(vector2D3);
//        pointSet.add(vector2D4);
//        pointSet.add(vector2D5);
//        pointSet.add(vector2D6);
//        pointSet.add(vector2D7);
//        pointSet.add(vector2D8);
        //

        List<Vector2D> pointSet = readTxtFile(
                "E:\\mck\\planar_algorithm\\src\\main\\java\\com\\huifer\\planar\\aset\\utils\\shptools\\triangulation\\1c.txt");
